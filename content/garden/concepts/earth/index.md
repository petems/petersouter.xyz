...
description: "Map projections, the Dymaxion map, and how the framing you choose determines what you can see."
...
![Dymaxion map projection showing the Earth's continents unfolded from an icosahedron](dymaxion-projection.png)
...
Ultimately, the reason this tickles my brain is it's another way perception and framing determine how we see something. Not only that, a lot of framing is invisible to the people using it!

Map projections are a clean example because they're literal and it's ingrained in your brain based on maps you see all through your life. It's a situation where you can point at the distortion and measure it, but the same principle applies everywhere. The same awareness of bias works as a mental model for how teams work, how software should be structured, how problems should be decomposed — these are all projections too!
