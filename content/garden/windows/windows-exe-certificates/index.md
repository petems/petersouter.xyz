...
This is specifically for [VidPare-Win](https://github.com/petems/VidPare-Win), the Windows version of my video processing tool. It's not a super pressing issue currently as I'm concentrating on the [OSX version](https://github.com/petems/VidPare) first. But it's another thing on my backlog to figure out at some point...
...
{{< info >}}
Funnily enough Coderabbit caught some of the mistakes from Claude's investigation in it's review of this post in the PR (See [this review comment](https://github.com/petems/petersouter.xyz/pull/168#discussion_r3069486602))... so maybe it's not as expensive as I thought... one for another time of investigation.
{{< /info >}}
