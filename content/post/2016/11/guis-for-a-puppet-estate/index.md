...
![Puppet Enterprise configuration management overview dashboard](puppet-enterprise-configuration-management-overview.png)

https://puppet.com/download-puppet-enterprise

## The Foreman:
**Open Source - GPL 3**
![](TheForemanOverview.png)
...
## PuppetBoard
![Puppetboard Screenshot](puppetboard.png)
