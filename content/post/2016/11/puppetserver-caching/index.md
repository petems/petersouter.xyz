...
description = ""
draft = false
coverImage = "puppet-server-threadpool-architecture.png"
...
![Puppet Server be fast, yo!](puppetconf-average-request-response-time.png)

![Agents running faster](puppetconf-agent-run-time-2000-agents.png)
