...
description = ""
draft = false
coverImage = "cockpit-selinux-access-control-overview.png"
...
#### Restarting Services:
![Cockpit services dashboard listing system services and their status](cockpit-services-dashboard.png)

#### Monitoring Disks:
![Cockpit storage dashboard showing filesystem usage and storage logs](cockpit-storage-dashboard.png)

#### Monitoring Network:
![Cockpit networking dashboard showing traffic spikes and interface stats](cockpit-networking-traffic-dashboard.png)
(You can see the spike where I downloaded a test file (`wget http://ipv4.download.thinkbroadband.com/100MB.zip`)

#### Reading Logs:
![Cockpit logs view with system and sudo log entries](cockpit-logs-dashboard.png)
...
![Cockpit web terminal running a simple shell command](cockpit-terminal-tool.png)
...
![Cockpit accounts page showing local user accounts](cockpit-accounts-page.png)
...
![Cockpit SELinux Access Control panel listing denied events](cockpit-selinux-access-control-panel.png)
