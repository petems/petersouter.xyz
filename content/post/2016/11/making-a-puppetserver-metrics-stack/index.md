...
description = ""
draft = false
coverImage = "grafana-puppetserver-jmx-overview-dashboard-cover.png"
...
![Grafana dashboard with Puppet Server thread count and heap memory metrics](grafana-puppetserver-jmx-overview-dashboard.png)
