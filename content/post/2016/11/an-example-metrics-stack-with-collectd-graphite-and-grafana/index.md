...
![Grafana panel showing a network traffic spike from a test file download](grafana-collectd-network-traffic-panel.png)
##### Note the bump when I ran the file download

![Grafana panel showing load averages increasing during stress test](grafana-collectd-load-average-panel.png)
